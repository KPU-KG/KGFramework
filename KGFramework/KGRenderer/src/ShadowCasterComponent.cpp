...
bool KG::Component::ShadowCasterComponent::OnDrawGUI()
{
    ...
    if (ImGui::ComponentHeader<KG::Component::ShadowCasterComponent>())
    {
        ...
        if (ImGui::Button("Toggle ShadowMap View"))
        {
            openDebug = !openDebug;
        }
        if (openDebug)
        {
            ...
            if (ImGui::Begin("ShadowMap PopUp"))
            {
                switch (this->GetTargetLightType())
                {
                case LightType::DirectionalLight:
                {
                    float width = ImGui::GetWindowWidth() / 4 - 20;
                    ImGui::SameLine();
                    ImGui::BeginGroup();
                    ImGui::SetNextItemWidth(width - 30);
                    ImGui::DragFloat("cas 0", this->GetDirectionalLightCamera()->cascadePoint + 1, 0.01f, 0.0f, 1.0f);
                    ...
                    ImGui::TextureView((ImTextureID)handle.ptr, ImVec2(width, width), "csm 0");
                    ImGui::EndGroup();

                    ImGui::SameLine();
                    ImGui::BeginGroup();
                    ImGui::SetNextItemWidth(width - 30);
                    ImGui::DragFloat("cas 1", this->GetDirectionalLightCamera()->cascadePoint + 2, 0.01f, 0.0f, 1.0f);
                    ...
                    ImGui::TextureView((ImTextureID)handle.ptr, ImVec2(width, width), "csm 1");
                    ImGui::EndGroup();

                    ImGui::SameLine();
                    ImGui::BeginGroup();
                    ImGui::SetNextItemWidth(width - 30);
                    ImGui::DragFloat("cas 2", this->GetDirectionalLightCamera()->cascadePoint + 3, 0.01f, 0.0f, 1.0f);
                    ...
                    ImGui::TextureView((ImTextureID)handle.ptr, ImVec2(width, width), "csm 2");
                    ImGui::EndGroup();

                    ImGui::SameLine();
                    ImGui::BeginGroup();
                    ImGui::SetNextItemWidth(width - 30);
                    ImGui::DragFloat("cas 3", this->GetDirectionalLightCamera()->cascadePoint + 4, 0.01f, 0.0f, 1.0f);
                    ...
                    ImGui::TextureView((ImTextureID)handle.ptr, ImVec2(width, width), "csm 3");
                    ImGui::EndGroup();
                }
                break;
                }
